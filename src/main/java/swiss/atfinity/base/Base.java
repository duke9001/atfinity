...
import swiss.atfinity.utility.ReadConfig;
...
public class Base {
	...
	public void setup(ITestContext context, @Optional("chrome") String browserName) {
		...
		//PageLoad TimeOuts
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(readConfig.getPageLoadTimeOut()));
